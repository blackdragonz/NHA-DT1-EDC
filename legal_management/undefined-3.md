...
![รูปภาพประกอบด้วย ซอฟต์แวร์, ข้อความ, ไอคอนคอมพิวเตอร์, จำนวน

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/0 (1).png>)

_รูปภาพที่ 108_ หน้าจองานคดีพิเศษ

1. กดที่ปุ่มแก้ไข ![](<../.gitbook/assets/1 (1).png>) ท้ายรายการคดีพิเศษที่ต้องการ

![รูปภาพประกอบด้วย ข้อความ, ซอฟต์แวร์, ไอคอนคอมพิวเตอร์, หน้าเว็บ

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/2 (1).png>)

_รูปภาพที่ 109_ หน้าจอแก้ไขงานประเภทคดีปกครอง
...
คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/3 (1).png>)

_รูปภาพที่ 110_ หน้าจอ Pop-up เพิ่มกรณีอื่นๆ

*
  1. กรอกข้อมูล“เลขที่สัญญา”
  2. กรอกข้อมูล“รหัสโครงการ - โครงการ”
  3. กรอกข้อมูล“บ้านเลขที่ / ตำแหน่งที่ตั้ง”
  4. กรอกข้อมูล“รหัสเจ้าหนี้”
  5. กรอกข้อมูล“ค่าเสียหาย”
  6. กรอกข้อมูล“รายละเอียดค่าเสียหาย
  7. กรอกข้อมูล“ชื่อสัญญา”
  8. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  9. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดเพิ่มสัญญาที่ลูกค้าทำกับการเคหะ “+ เลือกสัญญาที่ลูกค้าทำกับการเคหะ”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ไลน์, จำนวน

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/4 (1).png>)

_รูปภาพที่ 111_ หน้าจอ Pop-up เพิ่มสัญญาที่ลูกค้าทำกับการเคหะ

*
  1. กรอกข้อมูล“รหัสโครงการ/โครงการ”
  2. กรอกข้อมูล“ชื่อลูกค้า”
  3. กรอกข้อมูล“บ้านเลขที่ผัง”
  4. กรอกข้อมูล“บ้านเลขที่จริง”
  5. กรอกข้อมูล“รหัสลูกค้า”
  6. กรอกข้อมูล“เลขบัตรประจำตัวประชาชน”
  7. กรอกข้อมูล“เลขประจำตัวผู้เสียภาษี”
  8. กรอกข้อมูลเรียบร้อย กดปุ่ม “ค้นหาสัญญา”
  9. ยกเลิกข้อมูล กดปุ่ม “ล้างค่า”
  10. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  11. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดเพิ่มชื่อ-นามสกุล ผู้ที่เกี่ยวข้องในการดำเนินคดี “+ เพิ่มชื่อ-นามสกุล ผู้ที่เกี่ยวข้องในการดำเนินคดี”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ตัวอักษร, จำนวน

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/5 (1).png>)

_รูปภาพที่ 112_ หน้าจอ Pop-up เพิ่มชื่อ-นามสกุล ผู้ที่เกี่ยวข้องในการดำเนินคดี

*
  1. กรอกข้อมูล“คำนำหน้า”
  2. กรอกข้อมูล“ชื่อผู้เกี่ยวข้อง / ชื่อบริษัท”
  3. กรอกข้อมูล“นามสกุล”
  4. กรอกข้อมูล“ประเภท”
  5. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  6. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

### มอบหมายงาน <a href="#toc163217795" id="toc163217795"></a>

ระบบจะแสดงข้อมูลนิติกรที่ได้รับมอบหมายงาน

![รูปภาพประกอบด้วย ข้อความ, ซอฟต์แวร์, ไอคอนคอมพิวเตอร์, หน้าเว็บ

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/6 (1).png>)

_รูปภาพที่ 113_ หน้าจอรายการมอบหมายงาน คดีปกครอง
...
### การเตรียมคดีปกครอง <a href="#toc163217796" id="toc163217796"></a>

บันทึกข้อมูลการเตรียมคดีปกครอง เพื่อดำเนินคดี

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ซอฟต์แวร์, หน้าเว็บ

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/7 (1).png>)

_รูปภาพที่ 114_ หน้าจอแสดงการเตรียมคดีปกครอง
...
![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, จำนวน, ซอฟต์แวร์

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/8 (1).png>)

_รูปภาพที่ 115_ หน้าจอ Pop-up เพิ่มวันขอเอกสารเพิ่มเติม

*
  1. กรอกข้อมูล“วันขอเอกสารเพิ่มเติม”
  2. กรอกข้อมูล“วันที่ได้รับเอกสารเพิ่มเติม”
  3. กรอกข้อมูล“สถานะเอกสาร”
  4. กรอกข้อมูล“หมายเหตุ”
  5. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  6. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“สำนักงานอัยการผู้รับผิดชอบ”
2. กรอกข้อมูล“วันส่งเรื่องพนักงานอัยการ”
3. กดปุ่ม “+ เพิ่มวันพนักงานอัยการสอบข้อเท็จจริง”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, จำนวน, ตัวอักษร

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/9 (1).png>)

_รูปภาพที่ 116_ หน้าจอ Pop-up เพิ่มวันที่พนักงานอัยการสอบข้อเท็จจริง

*
  1. กรอกข้อมูล“วันที่พนักงานอัยการนัดสอบข้อเท็จจริง”
  2. กรอกข้อมูล“หมายเหตุ”
  3. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  4. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มวันส่งเอกสารเพิ่มเติมต่อพนักงานอัยการ”

![รูปภาพประกอบด้วย ข้อความ, อิเล็กทรอนิกส์, ภาพหน้าจอ, จำนวน

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/10 (1).png>)

_รูปภาพที่ 117_ หน้าจอ Pop-up เพิ่มวันที่ส่งเอกสารเพิ่มเติมต่อพนักงานอัยการ

*
  1. กรอกข้อมูล“วันที่ส่งเอกสารเพิ่มเติมต่อพนักงานอัยการ”
  2. กรอกข้อมูล“สถานะเอกสาร”
  3. กรอกข้อมูล“หมายเหตุ”
  4. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ไลน์, ขนาน

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/11 (1).png>)

_รูปภาพที่ 118_ หน้าจอบังคับคดีสืบทรัพย์ (1)

1. กรอกข้อมูลชื่อไฟล์เอกสารประกอบการฟ้องคดี
2. แนบไฟล์ กดปุ่ม “เพิ่มไฟล์”
3. บันทึกแนบไฟล์ กดไอคอน “![](<../.gitbook/assets/12 (1).png>)”
4. กรอกข้อมูล“หมายเหตุ”
5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”
6. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”

### การดำเนินคดีปกครองชั้นต้น <a href="#toc163217797" id="toc163217797"></a>

บันทึกข้อมูลการดำเนินคดีปกครองชั้นต้น

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ซอฟต์แวร์, ไอคอนคอมพิวเตอร์

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/13 (1).png>)

_รูปภาพที่ 119_ หน้าจอแสดงการดำเนินคดีปกครองชั้นต้น
...
คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/14 (1).png>)

_รูปภาพที่ 120_ หน้าจอ Pop-up เพิ่มวันยื่นคำให้การ

*
  1. กรอกข้อมูล“วันยื่นคำให้การ”
  2. กรอกข้อมูล“หมายเหตุ”
  3. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  4. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“วันสิ้นสุดแสวงหาข้อเท็จจริง”
2. กดปุ่ม “+ เพิ่มรายการวันนั่งพิจารณาคดีครั้งแรก”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, จำนวน, ไลน์

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/15 (1).png>)

_รูปภาพที่ 121_ หน้าจอ Pop-up เพิ่มรายการวันนั่งพิจารณาคดีครั้งแรก

*
  1. กรอกข้อมูล“วันนั่งพิจารณาคดีครั้งแรก”
  2. กรอกข้อมูล“หมายเหตุ”
  3. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  4. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“วันฟังคำพิพากษา”
2. กรอกข้อมูล“หมายเลขคดีแดง”
3. กรอกข้อมูล“คำพิพากษาโดยย่อ”
4. กรอกข้อมูล“หนี้ตามคำพิพากษา (บาท)”
5. กรอกข้อมูล“วันขอส่งคำบังคับ”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, ซอฟต์แวร์, ไอคอนคอมพิวเตอร์

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/16 (1).png>)

_รูปภาพที่ 122_ หน้าจอแสดงการดำเนินคดีปกครองชั้นต้น (1)

1. กดปุ่ม “+ เพิ่มรายการส่งคำบังคับ”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, จำนวน, ตัวอักษร

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/17 (1).png>)

_รูปภาพที่ 123_ หน้าจอ Pop-up เพิ่มรายการส่งคำบังคับ

*
  1. กรอกข้อมูล“ชื่อ-นามสกุล”
  2. กรอกข้อมูล“วันส่งคำบังคับ”
  3. กรอกข้อมูล“ส่งคำบังคับโดย”
  4. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มรายการคำร้อง”

![รูปภาพประกอบด้วย ข้อความ, ภาพหน้าจอ, จำนวน, ตัวอักษร

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/18 (1).png>)

_รูปภาพที่ 124_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
1. กรอกข้อมูลชื่อไฟล์เอกสารประกอบการฟ้องคดี
2. แนบไฟล์ กดปุ่ม “เพิ่มไฟล์”
3. บันทึกแนบไฟล์ กดไอคอน “![](<../.gitbook/assets/19 (1).png>)”
4. กรอกข้อมูล“หมายเหตุ”
5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”
6. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”

### การดำเนินคดีปกครองชั้นสูงสุด <a href="#toc163217798" id="toc163217798"></a>

บันทึกข้อมูลการดำเนินคดีปกครองชั้นสูงสุด

![รูปภาพประกอบด้วย ข้อความ, ซอฟต์แวร์, ไอคอนคอมพิวเตอร์, หน้าเว็บ

คำอธิบายที่สร้างโดยอัตโนมัติ](<../.gitbook/assets/20 (1).png>)

_รูปภาพที่ 125_ หน้าจอแสดงการดำเนินคดีปกครองชั้นอุทรณ์

1. เลือกที่เมนู“การดำเนินคดีปกครองชั้นสูงสุด”
2. กดปุ่ม “+ เพิ่มรายการยื่นอุทธรณ์”

_รูปภาพที่ 126_ หน้าจอ Pop-up เพิ่มรายการยื่นอุทธรณ์

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันยื่นอุทธรณ์”
  3. กรอกข้อมูล“ผู้ยื่นแก้อุทธรณ์”
  4. กรอกข้อมูล“วันยื่นแก้อุทธรณ์”
  5. กรอกข้อมูล“หมายเหตุ”
  6. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  7. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“วันฟังคำพิพากษาศาลปกครองสูงสุด”
2. กรอกข้อมูล“คำพิพากษาศาลปกครองสูงสุดโดยย่อ”
3. กรอกข้อมูล“หนี้ตามคำพิพากษาศาลปกครองสูงสุด”
4. กรอกข้อมูล“วันขอส่งคำบังคับ”

_รูปภาพที่ 127_ หน้าจอแสดงการดำเนินคดีปกครองชั้นสูงสุด (1)

1. กดปุ่ม “+ เพิ่มรายการส่งคำบังคับ”

_รูปภาพที่ 128_ หน้าจอ Pop-up เพิ่มรายการส่งคำบังคับ

*
  1. กรอกข้อมูล“ผู้ยื่นแก้อุทธรณ์”
  2. กรอกข้อมูล“วันยื่นแก้อุทธรณ์”
  3. กรอกข้อมูล“หมายเหตุ”
  4. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”
...
_รูปภาพที่ 129_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
### บังคับคดีสืบทรัพย์ <a href="#toc163217799" id="toc163217799"></a>

บันทึกข้อมูลบังคับคดีสืบทรัพย์

_รูปภาพที่ 130_ หน้าจอบังคับคดีสืบทรัพย์

1. เลือกที่เมนู“บังคับคดีสืบทรัพย์”
2. กดปุ่ม “+ เพิ่มรายการสืบทรัพย์ (อสังหาริมทรัพย์)”

_รูปภาพที่ 131_ หน้าจอ Pop-up เพิ่มรายการสืบทรัพย์ (อสังหาริมทรัพย์)

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันสืบทรัพย์”
  3. กรอกข้อมูล“สำนักงานที่ดิน”
  4. กรอกข้อมูล“วันแจ้งผลสืบทรัพย์”
  5. กรอกข้อมูล“ผลการสืบทรัพย์”
  6. กรอกข้อมูล“ประเภททรัพย์ที่สืบพบ”
  7. กรอกข้อมูล“ประเภทของเอกสารสิทธิ”
  8. กรอกข้อมูล“เลขที่เอกสารสิทธิ”
  9. กรอกข้อมูล“เลขที่เอกสารสิทธิ”
  10. กรอกข้อมูล“ที่ตั้งทรัพย์ที่สืบพบ”
  11. กรอกข้อมูล“เนื้อที่ (ไร่-งาน-วา ตารางวา/ตารางเมตร)”
  12. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  13. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มรายการสืบทรัพย์อื่น ๆ

_รูปภาพที่ 132_ หน้าจอ Pop-up เพิ่มรายการสืบทรัพย์อื่น ๆ

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันสืบทรัพย์”
  3. กรอกข้อมูล“สถานที่สืบทรัพย์”
  4. กรอกข้อมูล“วันแจ้งผลสืบทรัพย์”
  5. กรอกข้อมูล“ผลการสืบทรัพย์”
  6. กรอกข้อมูล“ประเภททรัพย์อื่น ๆ ที่สืบพบ”
  7. กรอกข้อมูล“รายละเอียดทรัพย์อื่น ๆ ที่สืบพบ”
  8. กรอกข้อมูล“มูลค่าทรัพย์”
  9. กรอกข้อมูล“ที่ตั้งทรัพย์ที่สืบพบ”
  10. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  11. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มรายการคำร้อง

_รูปภาพที่ 133_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
_รูปภาพที่ 134_ หน้าจอบังคับคดีสืบทรัพย์ (1)
...
### บังคับคดียึดทรัพย์ <a href="#toc163217800" id="toc163217800"></a>

บันทึกข้อมูลบังคับคดียึดทรัพย์ โดยทรัพย์จะต้องเป็นอสังหาริมทรัพย์

_รูปภาพที่ 135_ หน้าจอบังคับคดียึดทรัพย์

1. เลือกที่เมนู“บังคับคดีสืบทรัพย์”
2. กดปุ่ม “+ เพิ่มวันตั้งเรื่องบังคับคดีในเขต”

_รูปภาพที่ 136_ หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีในเขต
...
_รูปภาพที่ 137_ หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีข้ามเขต
...
1. กดปุ่ม “+ เพิ่มรายการยึดทรัพย์ (อสังหาริมทรัพย์)”

_รูปภาพที่ 138_ หน้าจอ Pop-up เพิ่มรายการยึดทรัพย์ (อสังหาริมทรัพย์)

*
  1. กรอกข้อมูล“หมายเลขสืบทรัพย์”
  2. กรอกข้อมูล“ชื่อ - นามสกุล”
  3. กรอกข้อมูล“วันที่ยึดทรัพย์”
  4. กรอกข้อมูล“วันขายทรัพย์ได้”
  5. กรอกข้อมูล“ราคาขายทรัพย์สูงสุด (บาท)”
  6. กรอกข้อมูล“วันนัดตรวจบัญชีรับ - จ่าย”
  7. กรอกข้อมูล“วันรับเงินขายทรัพย์”
  8. กรอกข้อมูล“จำนวนเงินที่ได้รับ (บาท)”
  9. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  10. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

_รูปภาพที่ 139_ หน้าจอบังคับคดียึดทรัพย์ (1)

1. กดปุ่ม “+ เพิ่มรายการยึดทรัพย์อื่น ๆ”

_รูปภาพที่ 140_ หน้าจอ Pop-up เพิ่มรายการยึดทรัพย์อื่น ๆ

*
  1. กรอกข้อมูล“หมายเลขสืบทรัพย์อื่น ๆ”
  2. กรอกข้อมูล“ชื่อ - นามสกุล”
  3. กรอกข้อมูล“ราคาประเมินเจ้าพนักงาน (บาท)”
  4. กรอกข้อมูล“วันที่ยึดทรัพย์”
  5. กรอกข้อมูล“วันขายทรัพย์ได้”
  6. กรอกข้อมูล“ราคาขายทรัพย์สูงสุด (บาท)”
  7. กรอกข้อมูล“วันนัดตรวจบัญชีรับ - จ่าย”
  8. กรอกข้อมูล“วันรับเงินขายทรัพย์”
  9. กรอกข้อมูล“จำนวนเงินที่ได้รับ (บาท)”
  10. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”
  11. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”

1. กดปุ่ม “+ เพิ่มรายการคำร้อง”

_รูปภาพที่ 141_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
### บังคับคดีอายัดทรัพย์ <a href="#toc163217801" id="toc163217801"></a>

การบันทึกข้อมูลบังคับคดีอายัดทรัพย์ โดยทรัพย์ต้องเป็นสังหา

_รูปภาพที่ 142_ หน้าจอบังคับคดีอายัดทรัพย์

1. เลือกที่เมนู“บังคับคดีอายัดทรัพย์”
2. กดปุ่ม “+ เพิ่มวันตั้งเรื่องบังคับคดีในเขต”

_รูปภาพที่ 143_ หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีในเขต
...
1. กดปุ่ม “+ เพิ่มรายการอายัดทรัพย์”

_รูปภาพที่ 144_ หน้าจอ Pop-up เพิ่มรายการอายัดทรัพย์

*
  1. กรอกข้อมูล“หมายเลขสืบทรัพย์อื่นๆ”
  2. กรอกข้อมูล“ชื่อ - นามสกุล”
  3. กรอกข้อมูล“วันที่อายัดทรัพย์”
  4. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มรายการคำร้อง”

_รูปภาพที่ 145_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
_รูปภาพที่ 146_ หน้าจอบังคับคดีสืบทรัพย์ (1)
...
### บังคับคดีขับไล่, รื้อถอน <a href="#toc163217802" id="toc163217802"></a>

บันทึกข้อมูลคดีขับไล่, รื้อถอน กรณีที่เป็นพื้นที่ของ กคช. และมีการประกาศจับ

_รูปภาพที่ 147_ หน้าจอบังคับคดีขับไล่, รื้อถอน

1. เลือกที่เมนู“บังคับคดีขับไล่, รื้อถอน”
2. กดปุ่ม “+ เพิ่มวันตั้งเรื่องบังคับคดีในเขต”

_รูปภาพที่ 148_ หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีในเขต
...
_รูปภาพที่ 149_ หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีข้ามเขต
...
_รูปภาพที่ 150_ หน้าจอ Pop-up เพิ่มรายการออกหมายจับ
...
_รูปภาพที่ 151_ หน้าจอ Pop-up เพิ่มวันนัดพร้อม
...
_รูปภาพที่ 152_ หน้าจอ Pop-up เพิ่มรายการคำร้อง
...
### คืนคดี/เสร็จคดี <a href="#toc163217803" id="toc163217803"></a>

### บันทึกข้อมูลคืนคดี/เสร็จคดีี



_รูปภาพที่ 153_ หน้าจอคืนคดี/เสร็จคดี
...
_รูปภาพที่ 156_ หน้าจอ Pop-up เพิ่มรายการ กคช. จ่ายเงิน
...
_รูปภาพที่ 157_ หน้าจอ Pop-up เพิ่มรายการ เงินวางศาล
...
1. กรอกข้อมูล“วันที่รับเงินวางศาล”
2. กรอกข้อมูล“จำนวนเงิน”

_รูปภาพที่ 158_ หน้าจอบังคับคดีสืบทรัพย์ (1)
...
_รูปภาพที่ 161_ ฟิลด์เพิ่มรายการค่าเสียหาย
...
_รูปภาพที่ 162_ หน้าจอคำนวณหนี้ (1)
