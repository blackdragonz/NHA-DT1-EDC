...
**รูปภาพที่ 170** หน้าจอบังคับคดีขับไล่, รื้อถอน

1. เลือกที่เมนู“บังคับคดีขับไล่, รื้อถอน”
2. กดปุ่ม “+ เพิ่มวันตั้งเรื่องบังคับคดีในเขต”

**รูปภาพที่ 171** หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีในเขต

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันตั้งเรื่อบังคับคดีในเขต”
  3. กรอกข้อมูล“สำนักงานบังคับคดีในเขต”
  4. กรอกข้อมูล“หมายเหตุ”
  5. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  6. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มวันตั้งเรื่องบังคับคดีข้ามเขต”

**รูปภาพที่ 172** หน้าจอ Pop-up เพิ่มวันตั้งเรื่องบังคับคดีข้ามเขต

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันตั้งเรื่อบังคับคดีข้ามเขต”
  3. กรอกข้อมูล“สำนักงานบังคับคดีข้ามเขต”
  4. กรอกข้อมูล“หมายเหตุ”
  5. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  6. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“วันปิดประกาศขับไล่/รื้อถอน”
2. กรอกข้อมูล“วัน จพค. รื้อถอนทรัพย์”
3. กรอกข้อมูล“วัน จพค. ส่งมอบการครอบครอง
4. กดปุ่ม “+ เพิ่มรายการออกหมายจับ”

**รูปภาพที่ 173** หน้าจอ Pop-up เพิ่มรายการออกหมายจับ

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันขอออกหมายจับ”
  3. กรอกข้อมูล“วันจับจำเลยและบริวาร”
  4. กรอกข้อมูล“หมายเหตุ”
  5. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  6. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กดปุ่ม “+ เพิ่มวันนัดพร้อม”

**รูปภาพที่ 174** หน้าจอ Pop-up เพิ่มวันนัดพร้อม

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันนัดพร้อม”
  3. กรอกข้อมูล“หมายเหตุ”
  4. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
  5. ไม่บันทึกข้อมูล กดปุ่ม “ยกเลิก”

1. กรอกข้อมูล“วันจำเลยและบริวารรื้อถอนทรัพย์”
2. กรอกข้อมูล“วันจำเลยและบริวารส่งมอบทรัพย์คืน”
3. กดปุ่ม “+ เพิ่มรายการคำร้อง”

**รูปภาพที่ 175** หน้าจอ Pop-up เพิ่มรายการคำร้อง

*
  1. กรอกข้อมูล“ชื่อ - นามสกุล”
  2. กรอกข้อมูล“วันยื่นคำร้อง”
  3. กรอกข้อมูล“ประเภทคำร้อง”
  4. กรอกข้อมูล“วันที่ยื่นคำคัดค้าน”
  5. กรอกข้อมูล“วันนัดไต่สวนคำร้อง”
  6. กรอกข้อมูล“วันฟังคำสั่งศาล”
  7. กรอกข้อมูล“คำสั่งศาลโดยย่อ”
  8. กรอกข้อมูล“หมายเหตุ”
  9. ข้อมูลเรียบร้อย กดปุ่ม “บันทึก”
...
### คืนคดี/เสร็จคดี <a href="#toc171692425" id="toc171692425"></a>

บันทึกข้อมูลคืนคดี/เสร็จคดี

**รูปภาพที่ 176** หน้าจอคืนคดี/เสร็จคดี
...
### ติดตามค่าเสียหาย <a href="#toc171692426" id="toc171692426"></a>
